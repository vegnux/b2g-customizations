...
<html>
  <head>
    <title>Dados do Perfil Javascript</title>
  </head>
  <style>
    .profile-file-title {
        font-size  : larger;
  ...
  <body>
    <h1>Dados do Perfil Javascript</h1>
    <span class="label">Data da coleta:</span>
    <span class="value">$full-date</span><br>
    <span class="label">Agente do usuário:</span>
    <span class="value">$user-agent</span><br>
    <span class="label">Versão do Depurador JavaScript:</span>
    <span class="value">$venkman-agent</span><br>
    <span class="label">Classificado por:</span>
...
@-range-start
      <span class="range-box">
        ...
        [ <a href="#section$section-number-prev">Arquivo anterior</a> |
        <a href="#section$section-number-next">Próximo arquivo</a> |
        <a href="#range$section-number:$range-number-prev">Escopo anterior</a> |
        <a href="#range$section-number:$range-number-next">Próximo escopo</a> ]
@-item-start
...
@-section-end
    <hr>
    <a href="http://www.mozilla.org/projects/venkman/">Nenhum trabalho é tão grande, nenhuma gratificação é tão grande.</a>
  </body>
</html>
